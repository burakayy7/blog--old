...
**Step 1:** If m is an even number, compute the trend-cycle component $$ \hat{T}_t $$ using a 2 x m-MA. If m is an odd number, compute the trend-cycle component $$ \hat{T}_t $$ using an m-MA; using this:
$$
